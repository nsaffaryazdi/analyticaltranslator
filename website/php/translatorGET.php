...
*/?>
    ...
    <html>
      <head>
	<title> Xpheres analytical translator </title>
      </head>
	...
	Xpheres translator<br><br>


<!-- 1. An HTML form request a text input to send it by post -->

	<form method="GET" action="translatorfunctionGET.php">

	    <p> Please write a sentence in german with maximum 10 words: <input type="text" name="text" /> </p>
...
//4.A connection to the database is made to collect all the values from every row where
      //every word is found and it writes the words in a table.
	...
	echo "Morpho-Syntactical analizer:";
	echo "<table cellpadding=5 border=0 id='tab1'>";
	echo "<tr> <td>"."<center>"."Position"."</td>";
 
    //We count the words and write the number from 1 to the last on the table like an index
	...
	echo "<td>"."<center>"."word"."</td>";

    //We write the words first

	for ($i=0; $i<=$numberofwords-1; $i++) 
	{
	    echo "<td>"."<center>"."$array[$i]"."</td>";
	}
	echo "</tr> ";

    //write the categories on the table
	echo "<tr> <td>"."<center>"."Category"."</td>";
...
//9. We write "type","prefix","declination"and "person" in the table.
        
    //Type
    echo "<tr> <td>"."<center>"."Type"."</td>";

    //Mostrat tipo
    for ($i=0; $i<=$numberofwords; $i++) {
    echo "<td>"."<center>"."$type[$i] "."$tense[$i] "."$prefix[$i]"."$declination[$i]"." $person[$i]"."</td>";
    }
    echo "</tr>";
    
    
//10. We write the row function in the table
    
    echo "<tr> <td>"."<center>"."Function"."</td>";

    for ($i=1; $i<=$numberofwords; $i++) {
    echo "<td>"."<center>"."$funcion[$i]"."</td>";
    }
    echo "</tr>";    
    
    
//11. We write the row case in the table
   
    echo "<tr> <td>"."<center>"."Case"."</td>";

    for ($i=0; $i<=$numberofwords; $i++) {
    echo "<td>"."<center>"."$case[$i]"."</td>";;
     }
...
//12.2. Gender concordances
	...
	echo"<error>";
	echo"Error! Genders are not correct! the article $word[$i] is $type[$i] $type2[$i] because the substantive $word[$imasuno] is $type[$imasuno] and in $case[$imasuno] case.";
	echo"</error>";
	$word[$i]=$cword[$i];
      }
    ...
    $spanish[$i]="la";  
    }else if($genero[$imasuno] =="masc" && $case[$imasuno]=="dative" && $category[$i]=="artdef"){
    $spanish[$i]="al";
    }else if($genero[$imasuno] =="fem" && $case[$imasuno]=="dative" && $category[$i]=="artdef"){
    $spanish[$i]="a la";
...
//12.3 Conjugation concordances
    ...
    //Conjugation is not correct 1st person "Ich komme"
	  ...
	  echo"<error>";
	  echo"Error! Conjugation is not correct! The personal pronoun $word[$i] is $person[$i] person while the verb $word[$imasuno] is $person[$imasuno] person.";
	  echo"</error>";
	...
	echo"<error>";
	echo"Error! Conjugation is not correct! The verb $word[$i] is $person[$i] person while the personal pronoun $word[$imasuno] is $person[$imasuno] person.";
	echo"</error>";
	...
	echo"<error>";
	echo"Error! Conjugation is not correct test! The verb $word[$i] is $person[$i] person while the personal pronoun $word[$imasuno] is $person[$imasuno] person.";
	echo"</error>";
    ...
    //Conjugation is not correct "der mann kommt"
	  ...
	  echo"<error>";
	  echo"Error! Conjugation is not correct! The verb $word[$imasdos] should be in the third person";
	  echo"</error>";

	}
 }
  
//13. Write the sentence corrected
    echo "<br>The correct sentence is: <br><br>";
...
//14. Translation
     echo "<br><br>Translation (Spanish): <br> <br>";
   for ($i=0; $i<=$numberofwords; $i++) 
	{
	echo"$spanish[$i] ";
	}
...
<a href="https://github.com/xpheres/analyticaltranslator"><td style=\"text-align:right\"> Read more information about this project here</td></a>
 <br><br>
  Did you find this software useful? You can contribute to this project by clicking the button below:<br>
  <a href="http://lingoworld.eu/lingoworld/donations/donate.php"><img border="0" alt="Support analytical translator" src="http://lingoworld.eu/lingoworld/banners/banner2.png" /></a>
</font>
