...
//12.2. Gender concordances
    ...
    // Art definite
    if ($category[$i]=="artdef" && $case[$imasuno]=="nominative" && $sutype[$imasuno]=="masculine") {    $word[$i]="der";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="femenine"){ $word[$i]="die";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="neutral"){  $word[$i]="das";
    
    }else if($category[$i]=="artdef" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="masculine"){  $word[$i]="den";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="femenine"){  $word[$i]="die";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="neutral"){  $word[$i]="das";
    
    }else if($category[$i]=="artdef" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="masculine"){  $word[$i]="dem";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="femenine"){  $word[$i]="der";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="neutral"){  $word[$i]="dem";
    
    }else if($category[$i]=="artdef" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="masculine"){  $word[$i]="dem";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="femenine"){  $word[$i]="der";
    }else if($category[$i]=="artdef" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="neutral"){  $word[$i]="dem";
    
    
    // Art indefinite
    
    }else if($category[$i]=="artindef" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="masculine"){ $word[$i]="ein";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="femenine"){ $word[$i]="eine";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="neutral"){  $word[$i]="ein";
    
    }else if($category[$i]=="artindef" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="masculine"){  $word[$i]="eines";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="femenine"){  $word[$i]="eine";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="neutral"){  $word[$i]="ein";
    
    }else if($category[$i]=="artindef" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="masculine"){  $word[$i]="einen";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="femenine"){  $word[$i]="einer";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="neutral"){  $word[$i]="ein";
    
    }else if($category[$i]=="artindef" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="masculine"){  $word[$i]="eines";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="femenine"){  $word[$i]="einer";
    }else if($category[$i]=="artindef" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="neutral"){  $word[$i]="eines";
    
        // Art negative
    
    }else if($category[$i]=="artneg" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="masculine"){ $word[$i]="kein";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="femenine"){ $word[$i]="keine";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="neutral"){  $word[$i]="kein";
    
    }else if($category[$i]=="artneg" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="masculine"){  $word[$i]="keines";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="femenine"){  $word[$i]="keine";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="neutral"){  $word[$i]="kein";
    
    }else if($category[$i]=="artneg" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="masculine"){  $word[$i]="keinen";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="femenine"){  $word[$i]="keiner";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="neutral"){  $word[$i]="kein";
    
    }else if($category[$i]=="artneg" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="masculine"){  $word[$i]="keines";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="femenine"){  $word[$i]="keiner";
    }else if($category[$i]=="artneg" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="neutral"){  $word[$i]="keines";
    
            // Art negative
    
    }else if($category[$i]=="artpos" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="masculine"){ $word[$i]="mein";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="femenine"){ $word[$i]="meine";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="nominative" && $subtype[$imasuno]=="neutral"){  $word[$i]="mein";
    
    }else if($category[$i]=="artpos" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="masculine"){  $word[$i]="meines";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="femenine"){  $word[$i]="meine";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="accusative" && $subtype[$imasuno]=="neutral"){  $word[$i]="mein";
    
    }else if($category[$i]=="artpos" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="masculine"){  $word[$i]="meinen";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="femenine"){  $word[$i]="meiner";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="dative" && $subtype[$imasuno]=="neutral"){  $word[$i]="mein";
    
    }else if($category[$i]=="artpos" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="masculine"){  $word[$i]="meines";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="femenine"){  $word[$i]="meiner";
    }else if($category[$i]=="artpos" && $case[$imasuno]=="genitive" && $subtype[$imasuno]=="neutral"){  $word[$i]="meines";
