...
if (FeldValue.length == 0) {				// to the php function translatorfunction.php to receive the translation
  ...
  return;
    ...
    xmlhttp.open("POST","http://lingoworld.eu/lingoworld/translator/website/php/translatorfunctionDE_EN.php",true);		//This send the request to the PHP function translatorfunction.php
